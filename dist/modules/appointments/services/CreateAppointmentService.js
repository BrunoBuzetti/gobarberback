...
let CreateAppointmentService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    const findAppointmentInSameDate = await this.appointmentsRepository.findByDate(appointmentDate, provider_user_id);
    ...
    await this.cacheProvider.invalidate(`provider-appointments:${provider_user_id}:${(0, _dateFns.format)(appointmentDate, 'yyyy-M-d')}`);
    return appointment;
  }
