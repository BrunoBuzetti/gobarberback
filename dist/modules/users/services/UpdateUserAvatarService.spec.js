...
describe('UpdateUserAvatar', () => {
  ...
  it('should be able to upload a new avatar for a user', async () => {
  ...
  it('should not be able to update avatar for a non existin user', async () => {
  ...
  it('should delete old avatar when updating new one', async () => {
    ...
    await updateUserAvatar.execute({
      user_id: user.id,
      avatarFilename: 'avatarNew.jpg'
    });
    expect(deleteFile).toHaveBeenCalledWith('avatar.jpg');
    expect(user.avatar).toBe('avatarNew.jpg');
  });
});